...
class MySprite(pygame.sprite.Sprite):
	...
	# all the code concerning the move is inside this method
	# this can be called on any instance of the soldier class.
	def moveX(self):
		x = self.getxPos()
		x += self.dx
		if x > SCREEN_WIDTH:
			x = 20
		self.rect.center =(x, self.getyPos())
...
while run:
	...
	# this replaces all the move code.
	player.moveX()
